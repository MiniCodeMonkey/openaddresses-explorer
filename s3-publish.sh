...
# Credits: https://github.com/sculpin/sculpin-blog-skeleton/blob/master/s3-publish.sh
...
s3cmd --config="$S3_CONFIG" $DRY_RUN --force --recursive $DELETE_REMOVED --bucket-location=$S3_REGION --progress --acl-public sync website/ s3://$S3_BUCKET 
